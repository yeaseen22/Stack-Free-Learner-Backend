...
exports.updateAssignmentMark = exports.getUserSubmissions = exports.getAllSubmissions = exports.submitAssignment = void 0;
...
const submitAssignment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { 
        // assignmentId,
        assignmentNo, submissionLink, batch, assignmentId, course, } = req.body;
...
const getAllSubmissions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const submissions = yield AssignmentSubmission_1.AssignmentSubmission.find().sort({
            submittedAt: -1,
        });
