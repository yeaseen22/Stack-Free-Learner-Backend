...
const AnnouncementModel_1 = __importDefault(require("../../models/email/AnnouncementModel"));
const sendBatchAnnouncement = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield AnnouncementModel_1.default.create({
            course: course._id,
            ...
            recipients: emailResults.map((result, index) => ({
                ...
                error: (result === null || result === void 0 ? void 0 : result.success) === false ? result.error : undefined,
            })),
