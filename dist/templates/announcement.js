...
const announcementTemplate = ({ name, courseTitle, batch, announcementTitle, announcementContent, instructorName = "The Course Team", announcementDate = new Date().toLocaleDateString(), }) => {
    return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
