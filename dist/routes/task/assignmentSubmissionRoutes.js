...
const submitAssignment_1 = require("../../controllers/task/submitAssignment");
...
router.get("/get-assignment-submissions", authMiddleware_1.authenticate, (0, checkRole_1.authorize)("student"), submitAssignment_1.getMyAssignmentSubmissions);
